...
# c.JupyterHub.admin_users =  {'brayan_admin'}
...
c.JupyterHub.pid_file = '/etc/jupyterhub/jupyterhub-run.pid'
...
c.JupyterHub.services = [
    {
        ...
        'command': ['jupyterhub-singleuser', '--group=shared', '--debug', '--allow-root'],
    }
]
...
# os.environ['OAUTH2_AUTHORIZE_URL'] =  "https://orcid.org/oauth/authorize"
# os.environ['OAUTH2_TOKEN_URL']  =  "https://orcid.org/oauth/token"

# print("***************ESTA ES TOKEN_URL**************",os.environ['OAUTH2_TOKEN_URL'])
# print("***************ESTA ES AUTHORIZE_URL************",os.environ['OAUTH2_AUTHORIZE_URL'])
...
### SANDBOX
# c.JupyterHub.authenticator_class.login_handler._OAUTH_AUTHORIZE_URL = "https://sandbox.orcid.org/oauth/authorize?scope=/authenticate"
...
c.JupyterHub.authenticator_class.login_handler._OAUTH_AUTHORIZE_URL = "https://orcid.org/oauth/authorize?scope=/authenticate"
c.JupyterHub.authenticator_class.login_handler._OAUTH_TOKEN_URL = "https://orcid.org/oauth/token"
c.OAuthenticator.client_id = 'APP-K70GZLOWTPC33OAB' # oauth2 client id for your app
c.OAuthenticator.client_secret = '533d9076-8ec0-4810-9189-f33a0ef7831a' # oauth2 client secret for your app
c.LocalGenericOAuthenticator.token_url = 'https://orcid.org/oauth/token' # oauth2 provider's token url
c.LocalGenericOAuthenticator.userdata_url = 'https://orcid.org/oauth/userinfo' # oauth2 provider's endpo
c.LocalGenericOAuthenticator.userdata_method = 'GET' # method used to request user data endpoint
c.LocalGenericOAuthenticator.userdata_params = {"Accept": "application/json"} # params to send for userdata endpoint
c.LocalGenericOAuthenticator.username_key = 'sub'
